...
def get_skill_list(db: mysql_connector.CMySQLConnection, table:str = 'isco_group', column_list:str = '*') -> list:
    return sql_reader.read_sql_data_to_list(db, table, column_list)

def get_skill_dataframe(db: mysql_connector.CMySQLConnection, table:str = 'isco_group', column_list:str = '*') -> pd.DataFrame:
