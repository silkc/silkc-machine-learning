...
def get_user_list(db: mysql_connector.CMySQLConnection, table:str = 'user', column_list:str = '*') -> list:
    return sql_reader.read_sql_data_to_list(db, table, column_list)

def get_user_dataframe(db: mysql_connector.CMySQLConnection, table:str = 'user', column_list:str = '*') -> pd.DataFrame:
